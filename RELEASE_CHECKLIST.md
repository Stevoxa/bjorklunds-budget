...
- [ ] **Höj `CACHE_NAME`** i `sw.js` vid varje release som ändrar cache-listan eller app shell (t.ex. `bjorklunds-budget-v35` → `v36`) så att klienter hämtar ny shell och gamla cache-versioner rensas vid aktivering.
